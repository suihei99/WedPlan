...
class BudgetService
{
  ...
  public function getSummary(Couple $couple): array
  {
    ...
    $totalAllocated = $categories->sum('allocated_amount');
    $totalSpent = $categories->flatMap->expenses->sum('amount');

    return [
      'total_budget_limit' => $couple->total_budget_limit,
      'total_allocated' => $totalAllocated,
      'total_spent' => $totalSpent,
      'remaining'=>$couple->total_budget_limit - $totalSpent,
